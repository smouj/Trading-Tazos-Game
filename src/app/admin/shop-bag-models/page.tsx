        ...
        {showAdd && (
          <div className="mag-card p-4 border-3 border-[#1a1a1a] shadow-[3px_3px_0px_#1a1a1a] bg-white">
            ...
            <div className="grid sm:grid-cols-3 gap-3 mb-3">
              ...
              <div><label className="text-[9px] font-black uppercase text-[#1a1a1a]/40">Series</label><select value={newFranchise} onChange={e => setNewFranchise(e.target.value)} className="w-full p-2 border-2 border-[#1a1a1a] text-xs font-bold">{FRANCHISES.map(f => <option key={f} value={f}>{f.toUpperCase()}</option>)}</select></div>
                  ...
                  <div className="flex items-start gap-4 p-4">
                    ...
                    {editingId === m.id ? (
                      <div className="flex-1 grid sm:grid-cols-3 gap-2">
                        ...
                        <div><label className="text-[8px] font-black text-[#1a1a1a]/40 uppercase">Series</label><select value={editFields.franchise || ""} onChange={e => setEditFields(p => ({ ...p, franchise: e.target.value }))} className="w-full p-1.5 border-2 border-[#1a1a1a] text-xs font-bold">{FRANCHISES.map(f => <option key={f} value={f}>{f.toUpperCase()}</option>)}</select></div>
