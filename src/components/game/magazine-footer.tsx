...
// platform badges, 7 page links, 5 social icons (X, Reddit,
// Telegram, Discord, Instagram), copyright, disclaimer.
...
export default function MagazineFooter() {
  return (
    ...
    >
      {/* Platform badges + Download button — identical to launcher */}
      ...
      {/* Links + Social — identical to launcher */}
      <div className="flex flex-col sm:flex-row items-center justify-between px-4 sm:px-6 py-2 gap-2">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          {/* Social icons — identical to launcher (5 icons, no GitHub) */}
      ...
      {/* Disclaimer — identical to launcher */}
